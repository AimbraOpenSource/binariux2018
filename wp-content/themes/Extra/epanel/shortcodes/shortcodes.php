...
function et_shortcodes_css_and_js(){
	...
	wp_localize_script( 'et-shortcodes-js', 'et_shortcodes_strings', array( 'previous' => esc_html__( 'Anterior', $themename ), 'next' => esc_html__( 'Próximo', $themename ) ) );
}
...
function et_learnmore($atts, $content = null) {
	...
	extract(shortcode_atts(array(
				"caption" => esc_html__( 'Clique aqui para ler mais', $themename ),
				"state" => 'close',
				"id" => '',
				"class" => ''
			), $atts, 'learn_more'));
	...
	<script type="text/javascript">
		var defaultSettings = {},
			...
			et_quicktags_strings = {
				...
				author     : "<?php esc_html_e( 'Adicionar biografia do autor', $themename ); ?>",
