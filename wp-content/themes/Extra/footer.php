	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( 'Projetado por %1$s | We love %2$s', 'extra' ) ), '<a href="http://www.aimbra.com" title="Aimbra - Desenvolvimento de Softwares">Aimbra</a>', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
