...
class ET_Social_Followers_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Siga-me', 'extra' );
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Título:', 'extra' ); ?></label>
...
class ET_Recent_Tweets_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_html_e( 'Exibição # de Tweets:', 'extra' ); ?><span class="description">(<?php esc_html_e( 'Máximo 200', 'extra' ); ?>)</span></label>
...
class ET_Authors_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'et_authors',
			esc_html__( 'Extra - Autores', 'extra' ),
			array(
				'description' => esc_html__( 'Exibir uma lista de autores.', 'extra' ),
			)
		);
	}
		...
		<div class="widget_content">
			<ul class="widget_list">
				...
				foreach ( $authors as $author ) {
					...
					$count = sprintf( _n( '%d Artigo', '%d Artigos', $count ), $count );
	...
	public function form( $instance ) {
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Outros autores', 'extra' );
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Título:', 'extra' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
...
class ET_Login_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array(
				'description' => esc_html__( 'Exibir um formulário de login: ', 'extra' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget_content">
			<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
				<ul class="widget_list">
					<li>
						<input class="input" type="text" name="log" placeholder="NOME DO USUÁRIO">
					</li>
					<li>
					...
					<li>
						...
						<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" class="post-meta"><?php esc_html_e( 'Esqueci minha senha', 'extra' ); ?></a>
					</li>
				</ul>
			</form>
		</div>
...
class ET_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct( 'et_ads', esc_html__( 'Extra - Publicidade', 'extra' ), array( 'description' => esc_html__( 'Exibir publicidade.', 'extra' ) ) );
	}
		...
		<div class="et_ads_widget" id="et_ads_widget_<?php echo esc_attr( $this->number ); ?>">
			...
			<div class="et_ads_widget_ads_container">
				...
				foreach ( $ads as $ad ) {
					...
					$img_alt_text = isset( $ad['img_alt_text'] ) ? $ad['img_alt_text'] : esc_attr__( 'Propaganda', 'extra' );
				...
				<div class="et_ads_ad group" data-ad_id="<?php echo esc_attr( $index ); ?>">
					...
					<div class="content">
						...
						<p class="field_wrap">
							<label for="<?php echo $this->get_ad_field_id( 'img_url', $index ); ?>"><?php esc_html_e( 'URL da Imagem:', 'extra' ); ?></label>
						...
						<p class="field_wrap">
							<label for="<?php echo esc_attr( $this->get_ad_field_id( 'img_alt_text', $index ) ); ?>"><?php esc_html_e( 'Imagem Alt Text:', 'extra' ); ?></label>
...
class ET_Recent_Posts_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Artigos recentes', 'extra' );
...
?>
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Título:', 'extra' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Número de artigos para exibir:', 'extra' ); ?></label>
		<input id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" value="<?php echo $number; ?>" size="3" /></p>

		<p><input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo $this->get_field_id( 'show_date' ); ?>" name="<?php echo $this->get_field_name( 'show_date' ); ?>" />
		<label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php esc_html_e( 'Exibir artigos por data?', 'extra' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_thumb' ); ?>"><?php esc_html_e( 'Exibir artigos em miniaturas?', 'extra' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_categories' ); ?>"><?php esc_html_e( 'Exibir artigos por categorias?', 'extra' ); ?></label></p>
<?php
	}
...
class ET_Recent_Reviews_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'et-recent-reviews', esc_html__( 'Extra - Visualizados recentemente', 'extra' ), $widget_ops );
...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Número de postagens para exibir:', 'extra' ); ?></label>
		<input id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" value="<?php echo $number; ?>" size="3" /></p>
<?php
	}
...
class ET_Recent_Comments_Widget extends WP_Widget {
	...
	?>
		...
		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Número de comentários para exibir:', 'extra' ); ?></label>
		<input id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" value="<?php echo $number; ?>" size="3" /></p>

		<p><input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo $this->get_field_id( 'show_date' ); ?>" name="<?php echo $this->get_field_name( 'show_date' ); ?>" />
		<label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php esc_html_e( 'Exibir comentários por data?', 'extra' ); ?></label></p>
	<?php
	}
