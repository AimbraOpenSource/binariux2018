							...
							<div class="post-wrap">
								...
								<div class="post-content">
									...
									if ( ! extra_is_builder_built() ) {
										wp_link_pages( array(
											'before' => '<div class="page-links">' . esc_html__( 'Páginas:', 'extra' ),
											'after'  => '</div>',
										) );
									}
									?>
						...
						<?php $user_color = !empty( $author->user_color ) ? $author->user_color : extra_global_accent_color(); ?>
							<div class="author" style="border-top-color:<?php echo esc_attr( $user_color ); ?>">
								...
								<div class="author-content">
									<a href="<?php echo esc_url( get_author_posts_url( $author->ID ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'Postado por: %s', 'extra' ), $author->display_name ) ); ?>" rel="author">
									...
									<a href="<?php echo esc_url( get_author_posts_url( $author->ID ) ); ?>" class="button post-count" title="<?php printf( esc_attr__( 'Postado por: %s', 'extra' ), $author->user_nicename ); ?>" rel="author"><?php esc_html_e( sprintf( _n( '%d Post', '%d Posts', $count ), $count ) ); ?></a>
								</div> <!-- /.author-content -->
