		...
		<div id="content-area" class="clearfix">
			<div class="et_pb_extra_column_main">
					...
					while ( have_posts() ) : the_post(); ?>
						...
						<nav class="post-nav">
							<div class="nav-links clearfix">
								<div class="nav-link nav-link-prev">
									<?php previous_post_link( '%link', et_get_safe_localization( __( '<span class="button">Anterior</span><span class="title">%title</span>', 'extra' ) ) ); ?>
								</div>
								<div class="nav-link nav-link-next">
									<?php next_post_link( '%link', et_get_safe_localization( __( '<span class="button">Próximo</span><span class="title">%title</span>', 'extra' ) ) ); ?>
								</div>
							</div>
						</nav>
						<?php
						...
						<div class="et_extra_other_module author-box vcard">
							<div class="author-box-header">
								<h3><?php esc_html_e( 'Sobre a autora', 'extra' ); ?></h3>
							</div>
							<div class="author-box-content clearfix">
								...
								<div class="author-box-description">
									<h4><a class="author-link url fn" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author" title="<?php printf( et_get_safe_localization( __( 'Ver todas as postagens de %s', 'extra' ) ), get_the_author() ); ?>"><?php echo get_the_author(); ?></a></h4>
				...
				<?php
					...
					?>
					<h2><?php esc_html_e( 'Desculpe, artigo não encontrado.', 'extra' ); ?></h2>
					<?php
				endif;
				wp_reset_query();
